--- Core utilities and shared data structures for test execution strategies
--- @module quicktest.strategies.core
...
--- @field adapter_data table Extension point for adapter-specific data that doesn't fit other fields
